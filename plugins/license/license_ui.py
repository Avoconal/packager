...
from qfluentwidgets import (CalendarPicker, LineEdit, SwitchButton)
...
class Ui_license(object):
    def setupUi(self, license):
        ...
        self.checkbox_switch = SwitchButton(license)
        ...
        self.checkbox_dark_mode = SwitchButton(license)
        ...
        self.dateedit = CalendarPicker(license)
    ...
    def retranslateUi(self, license):
        ...
        self.checkbox_switch.setText(QCoreApplication.translate("license", u"\u5173\u95ed\u6388\u6743", None))
